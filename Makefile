...
# For Centos7 add the following to the LDFLAGS define:   -lrt 
LDFLAGS         = -lz -lappdynamics -ldl -lpthread
...
once:	$(SATURATIONTEST_TEST_EXE)
	$(SDK_LOAD_PATH) ./$(SATURATIONTEST_TEST_EXE) ${SATURATIONTEST_EXE_OPTS} 1 1

some:	$(SATURATIONTEST_TEST_EXE)
	$(SDK_LOAD_PATH) ./$(SATURATIONTEST_TEST_EXE) ${SATURATIONTEST_EXE_OPTS} 10 10

lots:	$(SATURATIONTEST_TEST_EXE)
	$(SDK_LOAD_PATH) ./$(SATURATIONTEST_TEST_EXE) $(SATURATIONTEST_EXE_OPTS) 1000 1000
